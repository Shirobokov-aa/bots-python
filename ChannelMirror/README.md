...
3. Telethon слушает источники, очередь, публикация раз в `POST_INTERVAL_SECONDS` (дефолт 5400 ≈ 1.5 ч).
4. Пост уходит как «свой» (не forward).
...
python scripts/telethon_login.py   # → TELEGRAM_SESSION
