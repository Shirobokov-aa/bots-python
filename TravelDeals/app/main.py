...
from app.services.travelpayouts import close_tp_client

logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(name)s %(message)s")
log = logging.getLogger("traveldeals")
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        await close_tp_client()
        await bot.session.close()


app = FastAPI(title="TravelDeals", lifespan=lifespan)
